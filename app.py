...
from database import (
    init_db, create_user, verify_login, save_profile, load_profile,
    save_scan, load_scans, delete_scan, get_user_count, get_all_users
)
...
ADMIN_PASSWORD = "#Aneerah050870"  

st.markdown("""
<style>
    section[data-testid="stSidebar"] { background-color: #0d3b3e; }
    section[data-testid="stSidebar"] * { color: white !important; }
    div.stButton > button { background-color: #0f7a82; color: white; border-radius: 8px; border: none; }
    div.stButton > button:hover { background-color: #0a5a60; color: white; }
    .severity-severe { background-color: #fdeaea; border-left: 5px solid #d64545; padding: 10px 14px; border-radius: 8px; margin-bottom: 8px; }
    .severity-moderate { background-color: #fff6e5; border-left: 5px solid #e0a324; padding: 10px 14px; border-radius: 8px; margin-bottom: 8px; }
    .severity-mild { background-color: #eef7ee; border-left: 5px solid #4a9d4a; padding: 10px 14px; border-radius: 8px; margin-bottom: 8px; }
    .recipe-card { border: 1px solid #e0e0e0; border-radius: 10px; padding: 14px; margin-bottom: 10px; }
</style>
...
# ---- Recipes (add "image": "recipe_images/xxx.jpg" as you download each photo) ----
RECIPES = [
    {"name": "Avocado Toast on Gluten-Light Bread", "tags": ["Wheat"], "time": "10 min", "kcal": 320, "difficulty": "Easy",
     "image": "recipe_images/avocado_toast.jpg",
    ...
    {"name": "Oat Milk Banana Pancakes", "tags": ["Wheat"], "time": "20 min", "kcal": 410, "difficulty": "Easy",
     "image": "recipe_images/banana_pancakes.jpg",
    ...
    {"name": "Chickpea Stir-Fry with Rice", "tags": [], "time": "25 min", "kcal": 520, "difficulty": "Medium",
     "image": "recipe_images/chickpea_stirfry.jpg",
    ...
    {"name": "Berry Smoothie Bowl", "tags": ["Milk"], "time": "8 min", "kcal": 290, "difficulty": "Easy",
     "image": "recipe_images/smoothie_bowl.jpg",
    ...
    {"name": "Lentil Soup with Flatbread", "tags": ["Wheat"], "time": "35 min", "kcal": 380, "difficulty": "Easy",
     "image": "recipe_images/lentil_soup.jpg",
    ...
    {"name": "Peanut-Free Veggie Stir Fry", "tags": ["Soy"], "time": "20 min", "kcal": 350, "difficulty": "Easy",
     "image": "recipe_images/veggie_stirfry.jpg",
    ...
    {"name": "Shrimp-Free Garlic Rice Bowl", "tags": [], "time": "15 min", "kcal": 400, "difficulty": "Easy",
     "image": "recipe_images/garlic_rice_bowl.jpg",
    ...
    {"name": "Nasi Lemak", "tags": ["Fish", "Shellfish"], "time": "40 min", "kcal": 550, "difficulty": "Medium",
     "image": "recipe_images/nasi_lemak.jpg",
    ...
    {"name": "Roti Canai", "tags": ["Wheat"], "time": "45 min", "kcal": 300, "difficulty": "Medium",
     "image": "recipe_images/roti_canai.jpg",
    ...
    {"name": "Char Kway Teow", "tags": ["Shellfish", "Egg", "Soy"], "time": "20 min", "kcal": 600, "difficulty": "Medium",
     "image": "recipe_images/char_kway_teow.jpg",
    ...
    {"name": "Mee Goreng Mamak", "tags": ["Wheat", "Egg", "Soy"], "time": "20 min", "kcal": 480, "difficulty": "Easy",
     "image": "recipe_images/mee_goreng.jpg",
    ...
    {"name": "Beef Rendang", "tags": [], "time": "90 min", "kcal": 490, "difficulty": "Medium",
     "image": "recipe_images/beef_rendang.jpg",
    ...
    {"name": "Vegetable Fried Rice", "tags": ["Egg", "Soy"], "time": "15 min", "kcal": 380, "difficulty": "Easy",
     "image": "recipe_images/veg_fried_rice.jpg",
    ...
    {"name": "Chicken Rice Porridge (Congee)", "tags": [], "time": "40 min", "kcal": 280, "difficulty": "Easy",
     "image": "recipe_images/congee.jpg",
    ...
    {"name": "Egg Fried Noodles", "tags": ["Wheat", "Egg", "Soy"], "time": "15 min", "kcal": 420, "difficulty": "Easy",
     "image": "recipe_images/egg_fried_noodles.jpg",
    ...
    {"name": "Garlic Butter Pasta", "tags": ["Wheat", "Milk"], "time": "20 min", "kcal": 450, "difficulty": "Easy",
     "image": "recipe_images/garlic_butter_pasta.jpg",
    ...
    {"name": "Sweet and Sour Chicken", "tags": ["Soy"], "time": "30 min", "kcal": 460, "difficulty": "Medium",
     "image": "recipe_images/sweet_sour_chicken.jpg",
    ...
    {"name": "Grilled Chicken Salad", "tags": [], "time": "20 min", "kcal": 350, "difficulty": "Easy",
     "image": "recipe_images/chicken_salad.jpg",
    ...
    {"name": "Tuna Sandwich", "tags": ["Fish", "Wheat", "Egg"], "time": "10 min", "kcal": 340, "difficulty": "Easy",
     "image": "recipe_images/tuna_sandwich.jpg",
    ...
    {"name": "Banana Oat Muffins", "tags": ["Wheat", "Egg", "Milk"], "time": "35 min", "kcal": 290, "difficulty": "Medium",
     "image": "recipe_images/banana_oat_muffins.jpg",
    ...
    {"name": "Steamed Fish with Ginger and Soy Sauce", "tags": ["Fish", "Soy"], "time": "20 min", "kcal": 250, "difficulty": "Easy",
     "image": "recipe_images/steamed_fish.jpg",
    ...
    {"name": "Stir-Fried Tofu and Vegetables", "tags": ["Soy"], "time": "15 min", "kcal": 320, "difficulty": "Easy",
     "image": "recipe_images/tofu_stirfry.jpg",
...
def admin_screen():
    st.markdown("### Admin — User Stats")
    admin_password = st.text_input("Enter admin password", type="password")

    if admin_password == ADMIN_PASSWORD:
        st.success(f"Total signed-up users: {get_user_count()}")
        users = get_all_users()
        if users:
...
if not st.session_state.logged_in:
    ...
    with st.sidebar:
        ...
        page = st.radio("Navigate", ["Scan label", "Scan history", "Allergy profile", "Safe recipes", "Admin"], label_visibility="collapsed")
